...
public class RPC_HANDLERS {
  ...
  public static class RPC_Msg_Empty implements RPC_Msg {
    ...
    public void SetMessagesRangeAsSeen(
        PB_MsgResponse_SetChatMessagesRangeAsSeen pb, boolean handled) {
  ...
  public static RPC_HANDLERS.RPC_MessageReq RPC_MessageReq_Default_Handler =
      new RPC_HANDLERS.RPC_MessageReq_Empty();
  public static RPC_HANDLERS.RPC_MessageReqOffline RPC_MessageReqOffline_Default_Handler =
      new RPC_HANDLERS.RPC_MessageReqOffline_Empty();
  ...
  public static RPC_HANDLERS.RPC_UserOffline RPC_UserOffline_Default_Handler =
      new RPC_HANDLERS.RPC_UserOffline_Empty();
  ...
  public static void initMap() {
    ...
    maper.put(
        ...
        (pb, handled) -> {
          if (pb instanceof PB_ResponseLastChangesForTheRoom) {
            RPC_MessageReq_Default_Handler.GetLastChnagesForRoom(
                (PB_ResponseLastChangesForTheRoom) pb, handled);
          } else {
            Log.d(
                "RPC",
                " can not convert response object to PB_ResponseLastChangesForTheRoom in rpc: .GetLastChnagesForRoom ");
          }
        });
    ...
    maper.put(
        ...
        (pb, handled) -> {
          if (pb instanceof PB_ResponseSetLastSeenMessages) {
            RPC_MessageReqOffline_Default_Handler.SetLastSeen(
                (PB_ResponseSetLastSeenMessages) pb, handled);
          } else {
            Log.d(
                "RPC",
                " can not convert response object to PB_ResponseSetLastSeenMessages in rpc: .SetLastSeen ");
          }
        });
    ...
    maper.put(
        ...
        (pb, handled) -> {
          if (pb instanceof PB_ResRpcAddMsg) {
            ...
            Log.d(
                "RPC",
                " can not convert response object to PB_ResRpcAddMsg in rpc: .UploadNewMsg ");
          }
        });
    ...
    maper.put(
        ...
        (pb, handled) -> {
          if (pb instanceof PB_UserResponse_CheckUserName2) {
            ...
            Log.d(
                "RPC",
                " can not convert response object to PB_UserResponse_CheckUserName2 in rpc: .CheckPhone ");
          }
        });
    ...
    maper.put(
        ...
        (pb, handled) -> {
          if (pb instanceof PB_UserResponse_CheckUserName2) {
            ...
            Log.d(
                "RPC",
                " can not convert response object to PB_UserResponse_CheckUserName2 in rpc: .SendCode ");
          }
        });
    ...
    maper.put(
        ...
        (pb, handled) -> {
          if (pb instanceof PB_UserResponse_CheckUserName2) {
            ...
            Log.d(
                "RPC",
                " can not convert response object to PB_UserResponse_CheckUserName2 in rpc: .SendCodeToSms ");
          }
        });
    ...
    maper.put(
        ...
        (pb, handled) -> {
          if (pb instanceof PB_UserResponse_CheckUserName2) {
            RPC_Auth_Default_Handler.SendCodeToTelgram(
                (PB_UserResponse_CheckUserName2) pb, handled);
          } else {
            Log.d(
                "RPC",
                " can not convert response object to PB_UserResponse_CheckUserName2 in rpc: .SendCodeToTelgram ");
          }
        });
    ...
    maper.put(
        ...
        (pb, handled) -> {
          if (pb instanceof PB_UserResponse_CheckUserName2) {
            ...
            Log.d(
                "RPC",
                " can not convert response object to PB_UserResponse_CheckUserName2 in rpc: .SingUp ");
          }
        });
    ...
    maper.put(
        ...
        (pb, handled) -> {
          if (pb instanceof PB_UserResponse_CheckUserName2) {
            ...
            Log.d(
                "RPC",
                " can not convert response object to PB_UserResponse_CheckUserName2 in rpc: .SingIn ");
          }
        });
    ...
    maper.put(
        ...
        (pb, handled) -> {
          if (pb instanceof PB_UserResponse_CheckUserName2) {
            ...
            Log.d(
                "RPC",
                " can not convert response object to PB_UserResponse_CheckUserName2 in rpc: .LogOut ");
          }
        });
    ...
    maper.put(
        ...
        (pb, handled) -> {
          if (pb instanceof PB_MsgResponse_AddNewTextMessage) {
            RPC_Msg_Default_Handler.AddNewTextMessage(
                (PB_MsgResponse_AddNewTextMessage) pb, handled);
          } else {
            Log.d(
                "RPC",
                " can not convert response object to PB_MsgResponse_AddNewTextMessage in rpc: .AddNewTextMessage ");
          }
        });
    ...
    maper.put(
        ...
        (pb, handled) -> {
          if (pb instanceof PB_MsgResponse_SetRoomActionDoing) {
            RPC_Msg_Default_Handler.SetRoomActionDoing(
                (PB_MsgResponse_SetRoomActionDoing) pb, handled);
          } else {
            Log.d(
                "RPC",
                " can not convert response object to PB_MsgResponse_SetRoomActionDoing in rpc: .SetRoomActionDoing ");
          }
        });
    ...
    maper.put(
        ...
        (pb, handled) -> {
          if (pb instanceof PB_MsgResponse_GetMessagesByIds) {
            ...
            Log.d(
                "RPC",
                " can not convert response object to PB_MsgResponse_GetMessagesByIds in rpc: .GetMessagesByIds ");
          }
        });
    ...
    maper.put(
        ...
        (pb, handled) -> {
          if (pb instanceof PB_MsgResponse_GetMessagesHistory) {
            RPC_Msg_Default_Handler.GetMessagesHistory(
                (PB_MsgResponse_GetMessagesHistory) pb, handled);
          } else {
            Log.d(
                "RPC",
                " can not convert response object to PB_MsgResponse_GetMessagesHistory in rpc: .GetMessagesHistory ");
          }
        });
    ...
    maper.put(
        ...
        (pb, handled) -> {
          if (pb instanceof PB_MsgResponse_SetChatMessagesRangeAsSeen) {
            RPC_Msg_Default_Handler.SetMessagesRangeAsSeen(
                (PB_MsgResponse_SetChatMessagesRangeAsSeen) pb, handled);
          } else {
            Log.d(
                "RPC",
                " can not convert response object to PB_MsgResponse_SetChatMessagesRangeAsSeen in rpc: .SetMessagesRangeAsSeen ");
          }
        });
    ...
    maper.put(
        ...
        (pb, handled) -> {
          if (pb instanceof PB_MsgResponse_DeleteChatHistory) {
            RPC_Msg_Default_Handler.DeleteChatHistory(
                (PB_MsgResponse_DeleteChatHistory) pb, handled);
          } else {
            Log.d(
                "RPC",
                " can not convert response object to PB_MsgResponse_DeleteChatHistory in rpc: .DeleteChatHistory ");
          }
        });
    ...
    maper.put(
        ...
        (pb, handled) -> {
          if (pb instanceof PB_MsgResponse_DeleteMessagesByIds) {
            RPC_Msg_Default_Handler.DeleteMessagesByIds(
                (PB_MsgResponse_DeleteMessagesByIds) pb, handled);
          } else {
            Log.d(
                "RPC",
                " can not convert response object to PB_MsgResponse_DeleteMessagesByIds in rpc: .DeleteMessagesByIds ");
          }
        });
    ...
    maper.put(
        ...
        (pb, handled) -> {
          if (pb instanceof PB_MsgResponse_SetMessagesAsReceived) {
            RPC_Msg_Default_Handler.SetMessagesAsReceived(
                (PB_MsgResponse_SetMessagesAsReceived) pb, handled);
          } else {
            Log.d(
                "RPC",
                " can not convert response object to PB_MsgResponse_SetMessagesAsReceived in rpc: .SetMessagesAsReceived ");
          }
        });
    ...
    maper.put(
        ...
        (pb, handled) -> {
          if (pb instanceof PB_MsgResponse_ForwardMessages) {
            ...
            Log.d(
                "RPC",
                " can not convert response object to PB_MsgResponse_ForwardMessages in rpc: .ForwardMessages ");
          }
        });
    ...
    maper.put(
        ...
        (pb, handled) -> {
          if (pb instanceof PB_MsgResponse_EditMessage) {
            ...
            Log.d(
                "RPC",
                " can not convert response object to PB_MsgResponse_EditMessage in rpc: .EditMessage ");
          }
        });
    ...
    maper.put(
        ...
        (pb, handled) -> {
          if (pb instanceof PB_MsgResponse_BroadcastNewMessage) {
            RPC_Msg_Default_Handler.BroadcastNewMessage(
                (PB_MsgResponse_BroadcastNewMessage) pb, handled);
          } else {
            Log.d(
                "RPC",
                " can not convert response object to PB_MsgResponse_BroadcastNewMessage in rpc: .BroadcastNewMessage ");
          }
        });
    ...
    maper.put(
        ...
        (pb, handled) -> {
          if (pb instanceof PB_MsgResponse_PB_MsgParam_Echo) {
            ...
            Log.d(
                "RPC",
                " can not convert response object to PB_MsgResponse_PB_MsgParam_Echo in rpc: .Echo ");
          }
        });
    ...
    maper.put(
        ...
        (pb, handled) -> {
          if (pb instanceof PB_UserOfflineResponse_BlockUser) {
            RPC_UserOffline_Default_Handler.BlockUser(
                (PB_UserOfflineResponse_BlockUser) pb, handled);
          } else {
            Log.d(
                "RPC",
                " can not convert response object to PB_UserOfflineResponse_BlockUser in rpc: .BlockUser ");
          }
        });
    ...
    maper.put(
        ...
        (pb, handled) -> {
          if (pb instanceof PB_UserOfflineResponse_UnBlockUser) {
            RPC_UserOffline_Default_Handler.UnBlockUser(
                (PB_UserOfflineResponse_UnBlockUser) pb, handled);
          } else {
            Log.d(
                "RPC",
                " can not convert response object to PB_UserOfflineResponse_UnBlockUser in rpc: .UnBlockUser ");
          }
        });
    ...
    maper.put(
        ...
        (pb, handled) -> {
          if (pb instanceof PB_UserOfflineResponse_UpdateAbout) {
            RPC_UserOffline_Default_Handler.UpdateAbout(
                (PB_UserOfflineResponse_UpdateAbout) pb, handled);
          } else {
            Log.d(
                "RPC",
                " can not convert response object to PB_UserOfflineResponse_UpdateAbout in rpc: .UpdateAbout ");
          }
        });
    ...
    maper.put(
        ...
        (pb, handled) -> {
          if (pb instanceof PB_UserOfflineResponse_UpdateUserName) {
            RPC_UserOffline_Default_Handler.UpdateUserName(
                (PB_UserOfflineResponse_UpdateUserName) pb, handled);
          } else {
            Log.d(
                "RPC",
                " can not convert response object to PB_UserOfflineResponse_UpdateUserName in rpc: .UpdateUserName ");
          }
        });
    ...
    maper.put(
        ...
        (pb, handled) -> {
          if (pb instanceof PB_UserResponseOffline_ChangePrivacy) {
            RPC_UserOffline_Default_Handler.ChangePrivacy(
                (PB_UserResponseOffline_ChangePrivacy) pb, handled);
          } else {
            Log.d(
                "RPC",
                " can not convert response object to PB_UserResponseOffline_ChangePrivacy in rpc: .ChangePrivacy ");
          }
        });
    ...
    maper.put(
        ...
        (pb, handled) -> {
          if (pb instanceof PB_UserOfflineResponse_ChangeAvatar) {
            RPC_UserOffline_Default_Handler.ChangeAvatar(
                (PB_UserOfflineResponse_ChangeAvatar) pb, handled);
          } else {
            Log.d(
                "RPC",
                " can not convert response object to PB_UserOfflineResponse_ChangeAvatar in rpc: .ChangeAvatar ");
          }
        });
    ...
    maper.put(
        ...
        (pb, handled) -> {
          if (pb instanceof PB_UserResponse_CheckUserName) {
            ...
            Log.d(
                "RPC",
                " can not convert response object to PB_UserResponse_CheckUserName in rpc: .CheckUserName ");
          }
        });
    ...
    maper.put(
        ...
        (pb, handled) -> {
          if (pb instanceof PB_UserResponse_BlockedList) {
            ...
            Log.d(
                "RPC",
                " can not convert response object to PB_UserResponse_BlockedList in rpc: .GetBlockedList ");
          }
        });
  }
}
