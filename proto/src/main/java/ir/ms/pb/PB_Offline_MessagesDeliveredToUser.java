...
/**
 * Protobuf type {@code PB_Offline_MessagesDeliveredToUser}
 */
public  final class PB_Offline_MessagesDeliveredToUser extends
    com.google.protobuf.GeneratedMessageLite<
        PB_Offline_MessagesDeliveredToUser, PB_Offline_MessagesDeliveredToUser.Builder> implements
    // @@protoc_insertion_point(message_implements:PB_Offline_MessagesDeliveredToUser)
    PB_Offline_MessagesDeliveredToUserOrBuilder {
  private PB_Offline_MessagesDeliveredToUser() {
  ...
  public static ir.ms.pb.PB_Offline_MessagesDeliveredToUser parseFrom(
  ...
  public static ir.ms.pb.PB_Offline_MessagesDeliveredToUser parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return com.google.protobuf.GeneratedMessageLite.parseFrom(
        DEFAULT_INSTANCE, data);
  }
  ...
  public static ir.ms.pb.PB_Offline_MessagesDeliveredToUser parseFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageLite.parseFrom(
  ...
  public static ir.ms.pb.PB_Offline_MessagesDeliveredToUser parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return parseDelimitedFrom(DEFAULT_INSTANCE, input);
  }
  public static ir.ms.pb.PB_Offline_MessagesDeliveredToUser parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
  ...
  public static Builder newBuilder(ir.ms.pb.PB_Offline_MessagesDeliveredToUser prototype) {
  ...
  public static final class Builder extends
      com.google.protobuf.GeneratedMessageLite.Builder<
        ir.ms.pb.PB_Offline_MessagesDeliveredToUser, Builder> implements
      // @@protoc_insertion_point(builder_implements:PB_Offline_MessagesDeliveredToUser)
      ir.ms.pb.PB_Offline_MessagesDeliveredToUserOrBuilder {
    // Construct using ir.ms.pb.PB_Offline_MessagesDeliveredToUser.newBuilder()
    private Builder() {
    ...
    // @@protoc_insertion_point(builder_scope:PB_Offline_MessagesDeliveredToUser)
  }
  protected final Object dynamicMethod(
    ...
    switch (method) {
      case NEW_MUTABLE_INSTANCE: {
        return new ir.ms.pb.PB_Offline_MessagesDeliveredToUser();
      }
      case IS_INITIALIZED: {
      ...
      case VISIT: {
        ...
        ir.ms.pb.PB_Offline_MessagesDeliveredToUser other = (ir.ms.pb.PB_Offline_MessagesDeliveredToUser) arg1;
      ...
      case GET_PARSER: {
        if (PARSER == null) {    synchronized (ir.ms.pb.PB_Offline_MessagesDeliveredToUser.class) {
            if (PARSER == null) {
  ...
  // @@protoc_insertion_point(class_scope:PB_Offline_MessagesDeliveredToUser)
  private static final ir.ms.pb.PB_Offline_MessagesDeliveredToUser DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new PB_Offline_MessagesDeliveredToUser();
    DEFAULT_INSTANCE.makeImmutable();
  }

  public static ir.ms.pb.PB_Offline_MessagesDeliveredToUser getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static volatile com.google.protobuf.Parser<PB_Offline_MessagesDeliveredToUser> PARSER;

  public static com.google.protobuf.Parser<PB_Offline_MessagesDeliveredToUser> parser() {
