 ...
 * </pre>
 *
 * Protobuf type {@code PB_ChatParam_SetRoomActionDoing}
 */
public  final class PB_ChatParam_SetRoomActionDoing extends
    com.google.protobuf.GeneratedMessageLite<
        PB_ChatParam_SetRoomActionDoing, PB_ChatParam_SetRoomActionDoing.Builder> implements
    // @@protoc_insertion_point(message_implements:PB_ChatParam_SetRoomActionDoing)
    PB_ChatParam_SetRoomActionDoingOrBuilder {
  private PB_ChatParam_SetRoomActionDoing() {
    directRoomKey_ = "";
  }
  ...
  public static ir.ms.pb.PB_ChatParam_SetRoomActionDoing parseFrom(
  ...
  public static ir.ms.pb.PB_ChatParam_SetRoomActionDoing parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return com.google.protobuf.GeneratedMessageLite.parseFrom(
        DEFAULT_INSTANCE, data);
  }
  ...
  public static ir.ms.pb.PB_ChatParam_SetRoomActionDoing parseFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageLite.parseFrom(
  ...
  public static ir.ms.pb.PB_ChatParam_SetRoomActionDoing parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return parseDelimitedFrom(DEFAULT_INSTANCE, input);
  }
  public static ir.ms.pb.PB_ChatParam_SetRoomActionDoing parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
  ...
  public static Builder newBuilder(ir.ms.pb.PB_ChatParam_SetRoomActionDoing prototype) {
  ...
  public static final class Builder extends
      com.google.protobuf.GeneratedMessageLite.Builder<
        ir.ms.pb.PB_ChatParam_SetRoomActionDoing, Builder> implements
      // @@protoc_insertion_point(builder_implements:PB_ChatParam_SetRoomActionDoing)
      ir.ms.pb.PB_ChatParam_SetRoomActionDoingOrBuilder {
    // Construct using ir.ms.pb.PB_ChatParam_SetRoomActionDoing.newBuilder()
    private Builder() {
    ...
    // @@protoc_insertion_point(builder_scope:PB_ChatParam_SetRoomActionDoing)
  }
  protected final Object dynamicMethod(
    ...
    switch (method) {
      case NEW_MUTABLE_INSTANCE: {
        return new ir.ms.pb.PB_ChatParam_SetRoomActionDoing();
      }
      case IS_INITIALIZED: {
      ...
      case VISIT: {
        ...
        ir.ms.pb.PB_ChatParam_SetRoomActionDoing other = (ir.ms.pb.PB_ChatParam_SetRoomActionDoing) arg1;
      ...
      case GET_PARSER: {
        if (PARSER == null) {    synchronized (ir.ms.pb.PB_ChatParam_SetRoomActionDoing.class) {
            if (PARSER == null) {
  ...
  // @@protoc_insertion_point(class_scope:PB_ChatParam_SetRoomActionDoing)
  private static final ir.ms.pb.PB_ChatParam_SetRoomActionDoing DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new PB_ChatParam_SetRoomActionDoing();
    DEFAULT_INSTANCE.makeImmutable();
  }

  public static ir.ms.pb.PB_ChatParam_SetRoomActionDoing getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static volatile com.google.protobuf.Parser<PB_ChatParam_SetRoomActionDoing> PARSER;

  public static com.google.protobuf.Parser<PB_ChatParam_SetRoomActionDoing> parser() {
