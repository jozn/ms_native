...
public  final class PB_ChatView extends
  ...
  public ir.ms.pb.PB_MessageView getFirstUnreadMessage() {
    return firstUnreadMessage_ == null ? ir.ms.pb.PB_MessageView.getDefaultInstance() : firstUnreadMessage_;
  }
  /**
   * <code>.PB_MessageView FirstUnreadMessage = 210;</code>
   */
   ...
   * <code>.PB_MessageView FirstUnreadMessage = 210;</code>
   */
  private void clearFirstUnreadMessage() {  firstUnreadMessage_ = null;
  ...
  private void mergeLastMessage(ir.ms.pb.PB_MessageView value) {
    if (lastMessage_ != null &&
        lastMessage_ != ir.ms.pb.PB_MessageView.getDefaultInstance()) {
      lastMessage_ =
   ...
   * <code>.PB_MessageView LastMessage = 212;</code>
   */
  private void clearLastMessage() {  lastMessage_ = null;
  ...
  public int getSerializedSize() {
    ...
    if (updatedMs_ != 0L) {
      size += com.google.protobuf.CodedOutputStream
        .computeInt64Size(15, updatedMs_);
    }
    if (lastMessageId_ != 0L) {
      size += com.google.protobuf.CodedOutputStream
        .computeInt64Size(17, lastMessageId_);
    }
    if (lastDeletedMessageId_ != 0L) {
      size += com.google.protobuf.CodedOutputStream
    ...
    if (sharedMediaCount_ != 0) {
      size += com.google.protobuf.CodedOutputStream
        .computeInt32Size(200, sharedMediaCount_);
    }
    if (unseenCount_ != 0) {
      size += com.google.protobuf.CodedOutputStream
        .computeInt32Size(205, unseenCount_);
    }
    if (firstUnreadMessage_ != null) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(210, getFirstUnreadMessage());
    }
    if (lastMessage_ != null) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(212, getLastMessage());
    }
  ...
  public static final class Builder extends
     ...
     * <code>.PB_MessageView FirstUnreadMessage = 210;</code>
     */
    public Builder clearFirstUnreadMessage() {  copyOnWrite();
     ...
     * <code>.PB_MessageView LastMessage = 212;</code>
     */
    public Builder clearLastMessage() {  copyOnWrite();
    ...
    switch (method) {
      ...
      case VISIT: {
        ...
        unseenCount_ = visitor.visitInt(unseenCount_ != 0, unseenCount_,
            other.unseenCount_ != 0, other.unseenCount_);
        firstUnreadMessage_ = visitor.visitMessage(firstUnreadMessage_, other.firstUnreadMessage_);
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 1682: {
                ...
                firstUnreadMessage_ = input.readMessage(ir.ms.pb.PB_MessageView.parser(), extensionRegistry);
                if (subBuilder != null) {
              ...
              case 1698: {
                ...
                lastMessage_ = input.readMessage(ir.ms.pb.PB_MessageView.parser(), extensionRegistry);
                if (subBuilder != null) {
