...
public final class RPC_MessageReqGrpc {
  ...
  public static final io.grpc.MethodDescriptor<
          ir.ms.pb.PB_ReqLastChangesForTheRoom, ir.ms.pb.PB_ResponseLastChangesForTheRoom>
      METHOD_GET_LAST_CHNAGES_FOR_ROOM =
          io.grpc.MethodDescriptor
              .<ir.ms.pb.PB_ReqLastChangesForTheRoom, ir.ms.pb.PB_ResponseLastChangesForTheRoom>
                  newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName("RPC_MessageReq", "GetLastChnagesForRoom"))
   ...
   */
  public static RPC_MessageReqBlockingStub newBlockingStub(io.grpc.Channel channel) {
    return new RPC_MessageReqBlockingStub(channel);
  }

  /** Creates a new ListenableFuture-style stub that supports unary calls on the service */
  public static RPC_MessageReqFutureStub newFutureStub(io.grpc.Channel channel) {
    return new RPC_MessageReqFutureStub(channel);
  }

  /** */
  public abstract static class RPC_MessageReqImplBase implements io.grpc.BindableService {

    /** */
    public void getLastChnagesForRoom(
  ...
  /** */
  public static final class RPC_MessageReqStub
      extends io.grpc.stub.AbstractStub<RPC_MessageReqStub> {
    private RPC_MessageReqStub(io.grpc.Channel channel) {
      super(channel);
    }

    private RPC_MessageReqStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected RPC_MessageReqStub build(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
    ...
    public void getLastChnagesForRoom(
        ...
        io.grpc.stub.StreamObserver<ir.ms.pb.PB_ResponseLastChangesForTheRoom> responseObserver) {
      asyncUnaryCall(
          getChannel().newCall(METHOD_GET_LAST_CHNAGES_FOR_ROOM, getCallOptions()),
          request,
          responseObserver);
    }
  }
  ...
  /** */
  public static final class RPC_MessageReqBlockingStub
      extends io.grpc.stub.AbstractStub<RPC_MessageReqBlockingStub> {
    private RPC_MessageReqBlockingStub(io.grpc.Channel channel) {
      super(channel);
    }

    private RPC_MessageReqBlockingStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected RPC_MessageReqBlockingStub build(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      return new RPC_MessageReqBlockingStub(channel, callOptions);
    }

    /** */
    public ir.ms.pb.PB_ResponseLastChangesForTheRoom getLastChnagesForRoom(
        ir.ms.pb.PB_ReqLastChangesForTheRoom request) {
  ...
  /** */
  public static final class RPC_MessageReqFutureStub
      extends io.grpc.stub.AbstractStub<RPC_MessageReqFutureStub> {
    private RPC_MessageReqFutureStub(io.grpc.Channel channel) {
      super(channel);
    }

    private RPC_MessageReqFutureStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected RPC_MessageReqFutureStub build(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
    ...
    public com.google.common.util.concurrent.ListenableFuture<
            ir.ms.pb.PB_ResponseLastChangesForTheRoom>
        getLastChnagesForRoom(ir.ms.pb.PB_ReqLastChangesForTheRoom request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_LAST_CHNAGES_FOR_ROOM:
          serviceImpl.getLastChnagesForRoom(
              (ir.ms.pb.PB_ReqLastChangesForTheRoom) request,
              (io.grpc.stub.StreamObserver<ir.ms.pb.PB_ResponseLastChangesForTheRoom>)
                  responseObserver);
          break;
        default:
