...
public final class PB_MessageForwardedFrom
    extends com.google.protobuf.GeneratedMessageLite<
        PB_MessageForwardedFrom, PB_MessageForwardedFrom.Builder>
    implements
  ...
  public int getSerializedSize() {
    ...
    if (messageId_ != 0L) {
      size += com.google.protobuf.CodedOutputStream.computeInt64Size(3, messageId_);
    }
    if (messageSeq_ != 0) {
      size += com.google.protobuf.CodedOutputStream.computeInt32Size(4, messageSeq_);
    }
    memoizedSerializedSize = size;
    return size;
  }

  public static ir.ms.pb.PB_MessageForwardedFrom parseFrom(com.google.protobuf.ByteString data)
  ...
  public static final class Builder
      extends com.google.protobuf.GeneratedMessageLite.Builder<
          ir.ms.pb.PB_MessageForwardedFrom, Builder>
      implements
  ...
  protected final Object dynamicMethod(
    ...
    switch (method) {
      ...
      case VISIT:
        {
          ...
          messageSeq_ =
              visitor.visitInt(
                  messageSeq_ != 0, messageSeq_, other.messageSeq_ != 0, other.messageSeq_);
      ...
      case GET_PARSER:
        {
          if (PARSER == null) {
            synchronized (ir.ms.pb.PB_MessageForwardedFrom.class) {
              if (PARSER == null) {
