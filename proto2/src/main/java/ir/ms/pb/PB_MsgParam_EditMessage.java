 ...
 */
public final class PB_MsgParam_EditMessage
    extends com.google.protobuf.GeneratedMessageLite<
        PB_MsgParam_EditMessage, PB_MsgParam_EditMessage.Builder>
    implements
  ...
  public int getSerializedSize() {
    ...
    if (roomType_ != ir.ms.pb.RoomTypeEnum.UNKNOWN_ROOM_TYPE.getNumber()) {
      size += com.google.protobuf.CodedOutputStream.computeEnumSize(2, roomType_);
    }
    if (messageId_ != 0L) {
      size += com.google.protobuf.CodedOutputStream.computeInt64Size(3, messageId_);
    }
    if (!newText_.isEmpty()) {
      size += com.google.protobuf.CodedOutputStream.computeStringSize(4, getNewText());
    }
    memoizedSerializedSize = size;
    return size;
  }

  public static ir.ms.pb.PB_MsgParam_EditMessage parseFrom(com.google.protobuf.ByteString data)
  ...
  public static final class Builder
      extends com.google.protobuf.GeneratedMessageLite.Builder<
          ir.ms.pb.PB_MsgParam_EditMessage, Builder>
      implements
  ...
  protected final Object dynamicMethod(
    ...
    switch (method) {
      ...
      case VISIT:
        {
          ...
          roomType_ =
              visitor.visitInt(roomType_ != 0, roomType_, other.roomType_ != 0, other.roomType_);
          messageId_ =
              visitor.visitLong(
      ...
      case GET_PARSER:
        {
          if (PARSER == null) {
            synchronized (ir.ms.pb.PB_MsgParam_EditMessage.class) {
              if (PARSER == null) {
