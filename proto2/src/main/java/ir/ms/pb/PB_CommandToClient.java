...
public final class PB_CommandToClient
    extends com.google.protobuf.GeneratedMessageLite<PB_CommandToClient, PB_CommandToClient.Builder>
    implements
  ...
  /** <code>string Command = 2;</code> */
  private void setCommand(java.lang.String value) {
    if (value == null) {
  ...
  public int getSerializedSize() {
    ...
    if (!command_.isEmpty()) {
      size += com.google.protobuf.CodedOutputStream.computeStringSize(2, getCommand());
    }
    if (respondReached_ != false) {
      size += com.google.protobuf.CodedOutputStream.computeBoolSize(3, respondReached_);
    }
    if (!data_.isEmpty()) {
  ...
  public static ir.ms.pb.PB_CommandToClient parseFrom(com.google.protobuf.ByteString data)
  ...
  public static ir.ms.pb.PB_CommandToClient parseFrom(com.google.protobuf.CodedInputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, input);
  }
  ...
  public static final class Builder
      extends com.google.protobuf.GeneratedMessageLite.Builder<ir.ms.pb.PB_CommandToClient, Builder>
      implements
  ...
  protected final Object dynamicMethod(
    ...
    switch (method) {
      ...
      case VISIT:
        {
          ...
          command_ =
              visitor.visitString(
                  !command_.isEmpty(), command_, !other.command_.isEmpty(), other.command_);
          respondReached_ =
              visitor.visitBoolean(
                  respondReached_ != false,
                  respondReached_,
                  other.respondReached_ != false,
                  other.respondReached_);
          data_ =
      ...
      case GET_PARSER:
        {
          if (PARSER == null) {
            synchronized (ir.ms.pb.PB_CommandToClient.class) {
              if (PARSER == null) {
