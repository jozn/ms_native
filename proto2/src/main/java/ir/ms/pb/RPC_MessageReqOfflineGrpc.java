...
public final class RPC_MessageReqOfflineGrpc {
  ...
  public static final io.grpc.MethodDescriptor<
          ir.ms.pb.PB_RequestSetLastSeenMessages, ir.ms.pb.PB_ResponseSetLastSeenMessages>
      METHOD_SET_LAST_SEEN =
          io.grpc.MethodDescriptor
              .<ir.ms.pb.PB_RequestSetLastSeenMessages, ir.ms.pb.PB_ResponseSetLastSeenMessages>
                  newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName("RPC_MessageReqOffline", "SetLastSeen"))
   ...
   */
  public static RPC_MessageReqOfflineBlockingStub newBlockingStub(io.grpc.Channel channel) {
    return new RPC_MessageReqOfflineBlockingStub(channel);
  }

  /** Creates a new ListenableFuture-style stub that supports unary calls on the service */
  public static RPC_MessageReqOfflineFutureStub newFutureStub(io.grpc.Channel channel) {
    return new RPC_MessageReqOfflineFutureStub(channel);
  }

  /** */
  public abstract static class RPC_MessageReqOfflineImplBase implements io.grpc.BindableService {
          ...
          .addMethod(
              ...
              asyncUnaryCall(
                  new MethodHandlers<
                      ...
                      ir.ms.pb.PB_ResponseSetLastSeenMessages>(this, METHODID_SET_LAST_SEEN)))
          .build();
    }
  }

  /** */
  public static final class RPC_MessageReqOfflineStub
      extends io.grpc.stub.AbstractStub<RPC_MessageReqOfflineStub> {
    private RPC_MessageReqOfflineStub(io.grpc.Channel channel) {
      super(channel);
    }

    private RPC_MessageReqOfflineStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected RPC_MessageReqOfflineStub build(
  ...
  /** */
  public static final class RPC_MessageReqOfflineBlockingStub
      extends io.grpc.stub.AbstractStub<RPC_MessageReqOfflineBlockingStub> {
    private RPC_MessageReqOfflineBlockingStub(io.grpc.Channel channel) {
      super(channel);
    }

    private RPC_MessageReqOfflineBlockingStub(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected RPC_MessageReqOfflineBlockingStub build(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      return new RPC_MessageReqOfflineBlockingStub(channel, callOptions);
    }

    /** */
    public ir.ms.pb.PB_ResponseSetLastSeenMessages setLastSeen(
        ir.ms.pb.PB_RequestSetLastSeenMessages request) {
      return blockingUnaryCall(getChannel(), METHOD_SET_LAST_SEEN, getCallOptions(), request);
    }
  }

  /** */
  public static final class RPC_MessageReqOfflineFutureStub
      extends io.grpc.stub.AbstractStub<RPC_MessageReqOfflineFutureStub> {
    private RPC_MessageReqOfflineFutureStub(io.grpc.Channel channel) {
      super(channel);
    }

    private RPC_MessageReqOfflineFutureStub(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected RPC_MessageReqOfflineFutureStub build(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
    ...
    public com.google.common.util.concurrent.ListenableFuture<
        ...
        setLastSeen(ir.ms.pb.PB_RequestSetLastSeenMessages request) {
      return futureUnaryCall(getChannel().newCall(METHOD_SET_LAST_SEEN, getCallOptions()), request);
    }
  }
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SET_LAST_SEEN:
          serviceImpl.setLastSeen(
              (ir.ms.pb.PB_RequestSetLastSeenMessages) request,
              (io.grpc.stub.StreamObserver<ir.ms.pb.PB_ResponseSetLastSeenMessages>)
                  responseObserver);
          break;
        default:
