			...
			callback = new SuccessCallback() {
				...
				public void handle(byte[] data) {
					try {
						...
						Log.d("RPC", "parsing protocol buffer is faild: PB_ResponseLastChangesForTheRoom");
					}
				}
			};
		}
			...
			callback = new SuccessCallback() {
				...
				public void handle(byte[] data) {
					try {
						...
						Log.d("RPC", "parsing protocol buffer is faild: PB_MsgResponse_AddNewTextMessage");
					}
				}
			};
		}
			...
			callback = new SuccessCallback() {
				...
				public void handle(byte[] data) {
					try {
						...
						Log.d("RPC", "parsing protocol buffer is faild: PB_MsgResponse_SetRoomActionDoing");
					}
				}
			};
		}
			...
			callback = new SuccessCallback() {
				...
				public void handle(byte[] data) {
					try {
						...
						Log.d("RPC", "parsing protocol buffer is faild: PB_MsgResponse_GetMessagesHistory");
					}
				}
			};
		}
			...
			callback = new SuccessCallback() {
				...
				public void handle(byte[] data) {
					try {
						...
						Log.d("RPC", "parsing protocol buffer is faild: PB_MsgResponse_SetChatMessagesRangeAsSeen");
					}
				}
			};
		}
			...
			callback = new SuccessCallback() {
				...
				public void handle(byte[] data) {
					try {
						...
						Log.d("RPC", "parsing protocol buffer is faild: PB_MsgResponse_DeleteChatHistory");
					}
				}
			};
		}
			...
			callback = new SuccessCallback() {
				...
				public void handle(byte[] data) {
					try {
						...
						Log.d("RPC", "parsing protocol buffer is faild: PB_MsgResponse_DeleteMessagesByIds");
					}
				}
			};
		}
			...
			callback = new SuccessCallback() {
				...
				public void handle(byte[] data) {
					try {
						...
						Log.d("RPC", "parsing protocol buffer is faild: PB_MsgResponse_SetMessagesAsReceived");
					}
				}
			};
		}
			...
			callback = new SuccessCallback() {
				...
				public void handle(byte[] data) {
					try {
						...
						Log.d("RPC", "parsing protocol buffer is faild: PB_MsgResponse_BroadcastNewMessage");
					}
				}
			};
		}
			...
			callback = new SuccessCallback() {
				...
				public void handle(byte[] data) {
					try {
						...
						Log.d("RPC", "parsing protocol buffer is faild: PB_UserOfflineResponse_BlockUser");
					}
				}
			};
		}
			...
			callback = new SuccessCallback() {
				...
				public void handle(byte[] data) {
					try {
						...
						Log.d("RPC", "parsing protocol buffer is faild: PB_UserOfflineResponse_UnBlockUser");
					}
				}
			};
		}
			...
			callback = new SuccessCallback() {
				...
				public void handle(byte[] data) {
					try {
						...
						Log.d("RPC", "parsing protocol buffer is faild: PB_UserOfflineResponse_UpdateAbout");
					}
				}
			};
		}
			...
			callback = new SuccessCallback() {
				...
				public void handle(byte[] data) {
					try {
						...
						Log.d("RPC", "parsing protocol buffer is faild: PB_UserOfflineResponse_UpdateUserName");
					}
				}
			};
		}
			...
			callback = new SuccessCallback() {
				...
				public void handle(byte[] data) {
					try {
						...
						Log.d("RPC", "parsing protocol buffer is faild: PB_UserResponseOffline_ChangePrivacy");
					}
				}
			};
		}
			...
			callback = new SuccessCallback() {
				...
				public void handle(byte[] data) {
					try {
						...
						Log.d("RPC", "parsing protocol buffer is faild: PB_UserOfflineResponse_ChangeAvatar");
					}
				}
			};
		}
