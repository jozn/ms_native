...
/**
 * Protobuf type {@code PB_MsgsSeenToClient}
 */
public  final class PB_MsgsSeenToClient extends
    com.google.protobuf.GeneratedMessageLite<
        PB_MsgsSeenToClient, PB_MsgsSeenToClient.Builder> implements
    // @@protoc_insertion_point(message_implements:PB_MsgsSeenToClient)
    PB_MsgsSeenToClientOrBuilder {
  private PB_MsgsSeenToClient() {
    messageKey_ = "";
    roomKey_ = "";
  }
  ...
  public static ir.ms.pb.PB_MsgsSeenToClient parseFrom(
  ...
  public static ir.ms.pb.PB_MsgsSeenToClient parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return com.google.protobuf.GeneratedMessageLite.parseFrom(
        DEFAULT_INSTANCE, data);
  }
  ...
  public static ir.ms.pb.PB_MsgsSeenToClient parseFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageLite.parseFrom(
  ...
  public static ir.ms.pb.PB_MsgsSeenToClient parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return parseDelimitedFrom(DEFAULT_INSTANCE, input);
  }
  public static ir.ms.pb.PB_MsgsSeenToClient parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
  ...
  public static Builder newBuilder(ir.ms.pb.PB_MsgsSeenToClient prototype) {
  ...
  public static final class Builder extends
      com.google.protobuf.GeneratedMessageLite.Builder<
        ir.ms.pb.PB_MsgsSeenToClient, Builder> implements
      // @@protoc_insertion_point(builder_implements:PB_MsgsSeenToClient)
      ir.ms.pb.PB_MsgsSeenToClientOrBuilder {
    // Construct using ir.ms.pb.PB_MsgsSeenToClient.newBuilder()
    private Builder() {
    ...
    // @@protoc_insertion_point(builder_scope:PB_MsgsSeenToClient)
  }
  protected final Object dynamicMethod(
    ...
    switch (method) {
      case NEW_MUTABLE_INSTANCE: {
        return new ir.ms.pb.PB_MsgsSeenToClient();
      }
      case IS_INITIALIZED: {
      ...
      case VISIT: {
        ...
        ir.ms.pb.PB_MsgsSeenToClient other = (ir.ms.pb.PB_MsgsSeenToClient) arg1;
      ...
      case GET_PARSER: {
        if (PARSER == null) {    synchronized (ir.ms.pb.PB_MsgsSeenToClient.class) {
            if (PARSER == null) {
  ...
  // @@protoc_insertion_point(class_scope:PB_MsgsSeenToClient)
  private static final ir.ms.pb.PB_MsgsSeenToClient DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new PB_MsgsSeenToClient();
    DEFAULT_INSTANCE.makeImmutable();
  }

  public static ir.ms.pb.PB_MsgsSeenToClient getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static volatile com.google.protobuf.Parser<PB_MsgsSeenToClient> PARSER;

  public static com.google.protobuf.Parser<PB_MsgsSeenToClient> parser() {
