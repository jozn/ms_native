...
public final class PB_UserOfflineResponse_UpdateAbout
    extends com.google.protobuf.GeneratedMessageLite<
        PB_UserOfflineResponse_UpdateAbout, PB_UserOfflineResponse_UpdateAbout.Builder>
    implements
  ...
  public int getSerializedSize() {
    ...
    if (!newAbout_.isEmpty()) {
      size += com.google.protobuf.CodedOutputStream.computeStringSize(2, getNewAbout());
    }
  ...
  public static final class Builder
      extends com.google.protobuf.GeneratedMessageLite.Builder<
          ir.ms.pb.PB_UserOfflineResponse_UpdateAbout, Builder>
      implements
  ...
  protected final Object dynamicMethod(
    ...
    switch (method) {
      ...
      case VISIT:
        {
          ...
          ir.ms.pb.PB_UserOfflineResponse_UpdateAbout other =
              (ir.ms.pb.PB_UserOfflineResponse_UpdateAbout) arg1;
      ...
      case GET_PARSER:
        {
          if (PARSER == null) {
            synchronized (ir.ms.pb.PB_UserOfflineResponse_UpdateAbout.class) {
              if (PARSER == null) {
