...
public final class RpcMsgsGrpc {
  ...
  public static final io.grpc.MethodDescriptor<ir.ms.pb.PB_Message, ir.ms.pb.PB_ResRpcAddMsg>
      METHOD_UPLOAD_NEW_MSG =
          io.grpc.MethodDescriptor.<ir.ms.pb.PB_Message, ir.ms.pb.PB_ResRpcAddMsg>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName("RpcMsgs", "UploadNewMsg"))
   ...
   */
  public static RpcMsgsBlockingStub newBlockingStub(io.grpc.Channel channel) {
    return new RpcMsgsBlockingStub(channel);
  }

  /** Creates a new ListenableFuture-style stub that supports unary calls on the service */
  public static RpcMsgsFutureStub newFutureStub(io.grpc.Channel channel) {
    return new RpcMsgsFutureStub(channel);
  }

  /** */
  public abstract static class RpcMsgsImplBase implements io.grpc.BindableService {
    ...
    public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
              METHOD_UPLOAD_NEW_MSG,
              asyncUnaryCall(
                  new MethodHandlers<ir.ms.pb.PB_Message, ir.ms.pb.PB_ResRpcAddMsg>(
  ...
  public static final class RpcMsgsStub extends io.grpc.stub.AbstractStub<RpcMsgsStub> {
    ...
    private RpcMsgsStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected RpcMsgsStub build(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
  ...
  /** */
  public static final class RpcMsgsBlockingStub
      extends io.grpc.stub.AbstractStub<RpcMsgsBlockingStub> {
    private RpcMsgsBlockingStub(io.grpc.Channel channel) {
      super(channel);
    }

    private RpcMsgsBlockingStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected RpcMsgsBlockingStub build(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
    ...
    public ir.ms.pb.PB_ResRpcAddMsg uploadNewMsg(ir.ms.pb.PB_Message request) {
      return blockingUnaryCall(getChannel(), METHOD_UPLOAD_NEW_MSG, getCallOptions(), request);
    }
  }
  ...
  public static final class RpcMsgsFutureStub extends io.grpc.stub.AbstractStub<RpcMsgsFutureStub> {
    ...
    private RpcMsgsFutureStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected RpcMsgsFutureStub build(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<ir.ms.pb.PB_ResRpcAddMsg>
        uploadNewMsg(ir.ms.pb.PB_Message request) {
