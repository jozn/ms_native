 ...
 */
public final class PB_PushMsgAddMany
    extends com.google.protobuf.GeneratedMessageLite<PB_PushMsgAddMany, PB_PushMsgAddMany.Builder>
    implements
  ...
  /** <code>repeated .PB_UserWithMe Users = 3;</code> */
  public java.util.List<? extends ir.ms.pb.PB_UserWithMeOrBuilder> getUsersOrBuilderList() {
    return users_;
  }
  /** <code>repeated .PB_UserWithMe Users = 3;</code> */
  ...
  /** <code>repeated .PB_UserWithMe Users = 3;</code> */
  public ir.ms.pb.PB_UserWithMeOrBuilder getUsersOrBuilder(int index) {
    return users_.get(index);
  }
  ...
  /** <code>repeated .PB_UserWithMe Users = 3;</code> */
  private void setUsers(int index, ir.ms.pb.PB_UserWithMe value) {
    if (value == null) {
      throw new NullPointerException();
    }
  ...
  /** <code>repeated .PB_UserWithMe Users = 3;</code> */
  private void setUsers(int index, ir.ms.pb.PB_UserWithMe.Builder builderForValue) {
    ensureUsersIsMutable();
  ...
  /** <code>repeated .PB_UserWithMe Users = 3;</code> */
  private void addUsers(int index, ir.ms.pb.PB_UserWithMe value) {
    if (value == null) {
      throw new NullPointerException();
    }
    ensureUsersIsMutable();
  ...
  /** <code>repeated .PB_UserWithMe Users = 3;</code> */
  private void addUsers(ir.ms.pb.PB_UserWithMe.Builder builderForValue) {
    ensureUsersIsMutable();
    users_.add(builderForValue.build());
  }
  /** <code>repeated .PB_UserWithMe Users = 3;</code> */
  private void addUsers(int index, ir.ms.pb.PB_UserWithMe.Builder builderForValue) {
    ensureUsersIsMutable();
    users_.add(index, builderForValue.build());
  }
  /** <code>repeated .PB_UserWithMe Users = 3;</code> */
  private void addAllUsers(java.lang.Iterable<? extends ir.ms.pb.PB_UserWithMe> values) {
    ensureUsersIsMutable();
  ...
  public int getSerializedSize() {
    ...
    for (int i = 0; i < users_.size(); i++) {
      size += com.google.protobuf.CodedOutputStream.computeMessageSize(3, users_.get(i));
    }
    memoizedSerializedSize = size;
    return size;
  }

  public static ir.ms.pb.PB_PushMsgAddMany parseFrom(com.google.protobuf.ByteString data)
  ...
  public static ir.ms.pb.PB_PushMsgAddMany parseFrom(com.google.protobuf.CodedInputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, input);
  }
  ...
  public static final class Builder
      extends com.google.protobuf.GeneratedMessageLite.Builder<ir.ms.pb.PB_PushMsgAddMany, Builder>
      implements
    ...
    /** <code>repeated .PB_UserWithMe Users = 3;</code> */
    public Builder setUsers(int index, ir.ms.pb.PB_UserWithMe value) {
      copyOnWrite();
      instance.setUsers(index, value);
      return this;
    }
    /** <code>repeated .PB_UserWithMe Users = 3;</code> */
    public Builder setUsers(int index, ir.ms.pb.PB_UserWithMe.Builder builderForValue) {
      copyOnWrite();
    ...
    /** <code>repeated .PB_UserWithMe Users = 3;</code> */
    public Builder addUsers(int index, ir.ms.pb.PB_UserWithMe value) {
      copyOnWrite();
      instance.addUsers(index, value);
      return this;
    }
    /** <code>repeated .PB_UserWithMe Users = 3;</code> */
    public Builder addUsers(ir.ms.pb.PB_UserWithMe.Builder builderForValue) {
      copyOnWrite();
      instance.addUsers(builderForValue);
      return this;
    }
    /** <code>repeated .PB_UserWithMe Users = 3;</code> */
    public Builder addUsers(int index, ir.ms.pb.PB_UserWithMe.Builder builderForValue) {
      copyOnWrite();
      instance.addUsers(index, builderForValue);
      return this;
    }
    /** <code>repeated .PB_UserWithMe Users = 3;</code> */
    public Builder addAllUsers(java.lang.Iterable<? extends ir.ms.pb.PB_UserWithMe> values) {
      copyOnWrite();
  ...
  protected final Object dynamicMethod(
    ...
    switch (method) {
      ...
      case GET_PARSER:
        {
          if (PARSER == null) {
            synchronized (ir.ms.pb.PB_PushMsgAddMany.class) {
              if (PARSER == null) {
