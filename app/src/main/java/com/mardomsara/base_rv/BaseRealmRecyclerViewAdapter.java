...
///ME:: this is the merge from RealmRecyclerViewAdapter from real lib for android to BRAVA
 ...
 */
public abstract class BaseRealmRecyclerViewAdapter<T extends RealmModel, S extends BaseViewHolder>
     ...
     *
     * @see #BaseRealmRecyclerViewAdapter(OrderedRealmCollection, boolean, boolean)
     */
