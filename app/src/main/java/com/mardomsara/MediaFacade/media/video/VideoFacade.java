package com.mardomsara.MediaFacade.media.video;
...
public class VideoFacade {
	...
	public static class Bucket {
		 ...
		 */
		public @Nullable
		MediaCursor fetch(SortOrder order) {
...
//			return new VideoCursor(resolver.query(MediaStore.Video.Media.EXTERNAL_CONTENT_URI, null, BUCKET_GROUP_BY, null, order.toSql()));
		}
	}
	...
	public static class Video {
		 ...
		 */
		public @Nullable
		MediaCursor fetchByBucket(long bucketId) {
		 ...
		 */
		public @Nullable
		MediaCursor fetchByBucket(long bucketId, SortOrder order) {
