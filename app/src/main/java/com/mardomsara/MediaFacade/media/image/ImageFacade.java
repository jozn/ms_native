...
import com.mardomsara.MediaFacade.media.common.SortOrder;
...
//			return fetch(SortOrder.UNSPECIFIED);
			return fetch(""+MediaStore.Images.ImageColumns.DATE_MODIFIED + " DESC");
//			return fetch(""+MediaStore.Images.Media.DATE_MODIFIED + " DESC");
		}
...
//		public @Nullable ImageCursor fetch(SortOrder order) {
		public @Nullable ImageCursor fetch(String order) {
			return new ImageCursor(resolver.query(MediaStore.Images.Media.EXTERNAL_CONTENT_URI, BUCKET_PROJECTION, BUCKET_GROUP_BY, null, order));
		}
	}
	...
	public static class Image {
		...
		public @Nullable ImageCursor fetch() {
//			return fetch(SortOrder.UNSPECIFIED);
			return fetch(""+MediaStore.Images.ImageColumns.DATE_ADDED + " DESC");
		}
		 ...
		 */
		public @Nullable ImageCursor fetch(String order) {
			return new ImageCursor(resolver.query(MediaStore.Images.Media.EXTERNAL_CONTENT_URI, null, null, null, order));
		}
