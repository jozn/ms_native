 ...
 */
public class MsgPhotoMeView extends MsgAbstractViewHolder {
...
//    LinkerText msg_text;
    ...
    public MsgPhotoMeView(View itemView) {
        super(itemView);
        ButterKnife.bind(this, itemView);
    }

    public static MsgPhotoMeView makeNew(ViewGroup parent){
        return new MsgPhotoMeView(AppUtil.inflate(R.layout.msg_row_image_me,parent));
    }
