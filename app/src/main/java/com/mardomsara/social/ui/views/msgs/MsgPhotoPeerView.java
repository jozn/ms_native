...
//    @Bind(R.id.msg_delivery_status) TextView msg_delivery_status;
    ...
    public MsgPhotoPeerView(View itemView) {
        super(itemView);
        ButterKnife.bind(this, itemView);
    }

    public static MsgPhotoPeerView makeNew(ViewGroup parent){
        return new MsgPhotoPeerView(AppUtil.inflate(R.layout.msg_row_image_peer,parent));
    }
