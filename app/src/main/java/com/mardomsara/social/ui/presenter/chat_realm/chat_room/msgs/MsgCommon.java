...
//			image_holder.x.loading_progress.setProgress(95.0f);
	...
	//TODO needs to upgrade to realm
	public static void setVideoImage(RealmMessageView msg , ImageView msg_image) {
	...
	//todo upgrade to realm
    public static void msgDeliveryStatusText(RealmMessageView msg, TextView textView){
