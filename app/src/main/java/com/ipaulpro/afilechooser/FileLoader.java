...
public class FileLoader extends AsyncTaskLoader<List<File>> {
	...
	public List<File> loadInBackground() {
        ...
        final File[] dirs = pathDir.listFiles(FileChooserFileUtils.sDirFilter);
        if (dirs != null) {
            // Sort the folders alphabetically
            Arrays.sort(dirs, FileChooserFileUtils.sComparator);
        ...
        final File[] files = pathDir.listFiles(FileChooserFileUtils.sFileFilter);
        if (files != null) {
            // Sort the files alphabetically
            Arrays.sort(files, FileChooserFileUtils.sComparator);
